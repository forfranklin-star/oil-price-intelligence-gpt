...
def run_pipeline() -> dict:
    ...
    # DXY is a market series; if ICE/Yahoo transport is unavailable, use the
    # official FRED broad trade-weighted USD index as an explicitly labeled real-data fallback.
    ...
    diesel_provider = ChinaDieselProvider(cfg)
    diesel, src_diesel = diesel_provider.history(brent, cny)
    ...
    payload = {
        ...
        "data_status": {
            ...
            "china_diesel_sources": diesel_provider.diagnostics,
        },
...
if __name__ == "__main__":
    ...
    try:
        ...
        diagnostic = {
            ...
            "error": str(exc),
            "hint": "日报未生成。请先解决真实数据源错误；系统不会使用模拟数据。",
        }
        atomic_json_dump(diagnostic, ROOT / "reports" / "last_run_error.json")
        raise
